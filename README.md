...
Painter是由[酷家乐移动前端团队](https://github.com/Kujiale-Mobile)打造的一款小程序绘图组件。原项目地址为：https://github.com/Kujiale-Mobile/Painter

这款交互版原来是为了针对业务中的新需求而由我自己开发的，后来需求改动，所以并没有用上。组里[大佬](https://github.com/CPPAlien)考虑种种原因，让我先在自己的github上开源。这版painter与原版的区别在于：
...
```js
export default class PaletteCard {
    context = {}
    constructor(data) {
        this.data = data;
    }
